...
8. Unit: `bun test app/src bridge/src shared`. Mutation: `bun scripts/mutate.ts` (not Stryker). Runtime: `.cursor/skills/verify-dash`.
...
Dash-owned copy of this loop: `.cursor/skills/autodevelop/SKILL.md`. Prefer it for ownership, Metro, and `dash-pair` rules.
